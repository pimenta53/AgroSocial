...
class AssociationsControllerTest < ActionController::TestCase
  ...
  test "should create association" do
    assert_difference('Association.count') do
      post :create, association: { description: @association.description, email: @association.email, name: @association.name, password: @association.password, website: @association.website }
    end
  ...
  test "should update association" do
    put :update, id: @association, association: { description: @association.description, email: @association.email, name: @association.name, password: @association.password, website: @association.website }
    assert_redirected_to association_path(assigns(:association))
  end
